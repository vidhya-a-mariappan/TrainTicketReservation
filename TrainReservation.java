...
import static zsm.console.train.PassengerInfo.ID;
import static zsm.console.train.TicketProcess.bookingStatus;
import static zsm.console.train.TicketProcess.passengers;
        ...
        do{
            ...
            switch (option){
                ...
                case 3:
                    ...
                    System.out.println("Amount will be refunded to your bank account within 3 - 4 working days");
                    break;
                case 4:
